...
pcaAll <- readRDS("out_data/anyDirectionEigs_1000_PCA.rds")
...
# saveRDS(pca_less, "out_data/select_pca_all.RDS")
# export original coefs
# saveRDS(inds, "out_data/indx_for_pca_less_select_pa.RDS")
